<?php 
	...
	$mailUsername = $settings["mail_username"]; //public contact email address
?>
<div role="contentinfo" class="page-footer container-fluid">
	<div class="row">
		<div class="col-md-4">
			<h2>Questions? Contact <a href="mailto:<?php echo $mailUsername;?>?Subject=Global%20Expertise%20Database%20Question" target="_top"><?php echo $mailUsername;?></a> for help.</h2>
